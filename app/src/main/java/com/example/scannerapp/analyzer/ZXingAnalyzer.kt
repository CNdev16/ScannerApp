package com.example.scannerapp.analyzer
...
/**
 * Copy right.
 * @see <a href="https://github.com/maulikhirani/scannerX">Github ScannerX</a>
 */
class ZXingAnalyzer(private val result: (result: String) -> Unit) : ImageAnalysis.Analyzer {
    ...
    override fun analyze(image: ImageProxy) {
        if ((
                    image.format == ImageFormat.YUV_420_888 || image.format == ImageFormat.YUV_422_888 ||
